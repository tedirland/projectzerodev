    ...
    <section className="section-title">
      <div className="px-2">
        <div className="pt-5 pb-4">
          <h1>Recent Sustainibility News</h1>
        </div>
      </div>
    </section>
      ...
      <div className="list-group">
        ...
        >
          ...
          <div className="avatar-container my-2">
            ...
            ></img>
            <span className="avatar-title">Brad Bays</span>
          </div>
        </a>
        <a
          href="#"
        ...
        >
          ...
          <div className="avatar-container my-2">
            <img
              ...
              className="avatar-image mr-2"
            ></img>
            <span className="avatar-title">Kwame Kilpatrick</span>
          </div>
        </a>
        <a
          href="#"
        ...
        >
          ...
          <div className="avatar-container my-2">
            <img
              ...
              className="avatar-image mr-2"
            ></img>
            <span className="avatar-title">Don Muhlbach</span>
          </div>
        </a>
      </div>
    </section>
